...
@section('content')
    ...
    <main class="flex-1 px-4 sm:px-6 lg:px-8 pb-6 space-y-6">
            ...
            <section class="box-border grid grid-cols-2 gap-6 mb-[22px]">
                <a href="#" class="box-border min-h-[80px] px-7 py-6 border border-[#E6E6E6] shadow-sm rounded-2xl bg-white hover:bg-gray-50 transition-colors flex items-center text-[#000000] text-[22px] leading-[1.2] font-extrabold no-underline">Tambah Akun</a>
                <a href="#" class="box-border min-h-[80px] px-7 py-6 border border-[#E6E6E6] shadow-sm rounded-2xl bg-white hover:bg-gray-50 transition-colors flex items-center text-[#000000] text-[22px] leading-[1.2] font-extrabold no-underline">Edit Data Akun</a>
            </section>
            ...
            <section class="box-border border border-[#E6E6E6] shadow-sm rounded-2xl bg-white overflow-hidden">
                ...
                <div class="box-border min-h-[360px] m-0 border-t border-[#E6E6E6] rounded-[14px] overflow-x-auto">
                    <table class="box-border w-full min-w-[760px] border-collapse">
                        ...
                        <tbody>
                            <tr>
                                <td colspan="7" class="box-border h-[260px] p-0"></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
