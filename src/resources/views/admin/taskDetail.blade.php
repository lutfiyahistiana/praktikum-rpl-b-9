...
@section('content')
    ...
    <main class="flex-1 px-4 sm:px-6 lg:px-8 pb-6 space-y-6">
        ...
        {{-- Back button --}}
        <a href="{{ route('admin.task') }}" class="inline-flex items-center gap-2 text-sm font-medium text-gray-500 hover:text-gray-700 transition-colors">
            ...
            <div class="w-full md:w-3/5">
                <div class="bg-white rounded-xl border border-[#E6E6E6] p-5 sm:p-6 h-full">
                    ...
                    <p class="text-sm text-[#969696] mb-4">
                        Ditugaskan kepada: {{ $task->assignee ? $task->assignee->name : '-' }}
                    </p>
                ...
                <div class="bg-white rounded-xl border border-[#E6E6E6] p-5 sm:p-6 h-full space-y-4">
                    ...
                    <div class="space-y-3 text-sm">
                        <div class="flex justify-between">
                            <span class="text-[#969696]">Tim</span>
