...
<head>
    ...
    <title>Dashboard Anggota - Colab</title>
    ...
    <aside id="sidebar"
        ...
        <nav class="flex-1 flex flex-col px-4 overflow-y-auto">
            ...
            <div class="mb-6">
                ...
                <ul class="space-y-1">
                    <li>
                        <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-gray-500 hover:bg-colab-gray-light transition-colors">
            ...
            <div class="mb-6">
                ...
                <ul class="space-y-1">
                    {{-- Dashboard — Aktif --}}
                    <li>
                        <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-bold text-colab-blue bg-blue-50 border-l-4 border-colab-blue hover:bg-blue-50 transition-colors">
                    ...
                    {{-- Task --}}
                    <li>
                        <a href="/task/anggota" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-gray-500 hover:bg-colab-gray-light transition-colors">
                    ...
                    {{-- Materials --}}
                    <li>
                        <a href="/materials/anggota" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-gray-500 hover:bg-colab-gray-light transition-colors">
