        ...
        <nav class="flex-1 flex flex-col px-4 overflow-y-auto">
            ...
            <div class="mb-6">
                ...
                <ul class="space-y-1">
                    {{-- Dashboard --}}
                    <li>
                        <a href="{{ route('anggota_tim.dashboard') }}"
                            class="flex items-center gap-3 px-3 rounded-lg text-sm transition-colors
                                {{ request()->is('anggota-tim/dashboard')
                                    ? 'font-bold text-colab-blue bg-blue-50 border-l-4 border-colab-blue'
                                    : 'text-gray-500 hover:bg-colab-gray-light' }}">
                            <img src="{{ asset(request()->is('anggota-tim/dashboard') ? 'images/dashboard-active.png' : 'images/dashboard.png') }}"
                    ...
                    {{-- Task --}}
                    <li>
                        <a href="{{ route('anggota_tim.task') }}"
                            class="flex items-center gap-3 px-3 rounded-lg text-sm transition-colors
                                {{ request()->is('anggota-tim/task*')
                                    ? 'font-bold text-colab-blue bg-blue-50 border-l-4 border-colab-blue'
                                    : 'text-gray-500 hover:bg-colab-gray-light' }}">
                            <img src="{{ asset(request()->is('anggota-tim/task*') ? 'images/task-active.png' : 'images/task.png') }}"
                    ...
                    {{-- Materials --}}
                    <li>
                        <a href="{{ route('anggota_tim.materials') }}"
                            class="flex items-center gap-3 px-3 rounded-lg text-sm transition-colors
                                {{ request()->is('anggota-tim/materials*')
                                    ? 'font-bold text-colab-blue bg-blue-50 border-l-4 border-colab-blue'
                                    : 'text-gray-500 hover:bg-colab-gray-light' }}">
                            <img src="{{ asset(request()->is('anggota-tim/materials*') ? 'images/materials-active.png' : 'images/materials.png') }}"
