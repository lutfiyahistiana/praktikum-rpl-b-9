                    ...
                    <table class="box-border w-full min-w-[760px] border-collapse">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b border-[#E6E6E6] hover:bg-gray-50 transition-colors">
                                <td class="box-border px-6 py-4 text-[#111827] text-sm font-semibold">{{ $user->name }}</td>
                                <td class="box-border px-6 py-4 text-[#767676] text-sm">{{ $user->nim ?? '-' }}</td>
                                <td class="box-border px-6 py-4 text-[#767676] text-sm">{{ $user->prodi ?? '-' }}</td>
                                <td class="box-border px-6 py-4 text-[#767676] text-sm">{{ $user->fakultas ?? '-' }}</td>
                                <td class="box-border px-6 py-4 text-[#767676] text-sm">-</td>
                                <td class="box-border px-6 py-4 text-[#767676] text-sm">-</td>
