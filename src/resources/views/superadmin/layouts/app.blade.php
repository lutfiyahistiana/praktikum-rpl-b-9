...
<head>
    ...
    <meta name="description" content="Dashboard Superadmin - Colab, aplikasi manajemen tim kolaboratif.">
        ...
        <nav class="flex-1 flex flex-col px-4 overflow-y-auto">
            ...
            <div class="mb-6">
                ...
                <ul class="space-y-1">
                        ...
                        <a href="{{ route('superadmin.dashboard') }}"
                            class="flex items-center gap-3 px-3 rounded-lg text-sm transition-colors
                                {{ request()->is('superadmin/dashboard')
                                    ? 'font-bold text-colab-blue bg-blue-50 border-l-4 border-colab-blue'
                                    : 'text-gray-500 hover:bg-colab-gray-light' }}">
                            <img src="{{ asset(request()->is('superadmin/dashboard') ? 'images/dashboard-active.png' : 'images/dashboard.png') }}"
                    ...
                    {{-- Task --}}
                    <li>
                        <a href="{{ route('superadmin.task') }}"
                            class="flex items-center gap-3 px-3 rounded-lg text-sm transition-colors
                                {{ request()->is('superadmin/task*')
                                    ? 'font-bold text-colab-blue bg-blue-50 border-l-4 border-colab-blue'
                                    : 'text-gray-500 hover:bg-colab-gray-light' }}">
                            <img src="{{ asset(request()->is('superadmin/task*') ? 'images/task-active.png' : 'images/task.png') }}"
                    ...
                    {{-- Task --}}
                    <li>
                        <a href="{{ route('superadmin.manageRole') }}"
                            class="flex items-center gap-3 px-3 rounded-lg text-sm transition-colors
                                {{ request()->is('superadmin/manage-role*')
                                    ? 'font-bold text-colab-blue bg-blue-50 border-l-4 border-colab-blue'
                                    : 'text-gray-500 hover:bg-colab-gray-light' }}">
                            <img src="{{ asset(request()->is('superadmin/manage-role*') ? 'images/manage-active.png' : 'images/manage.png') }}"
                                alt="Task" class="w-14 h-14 object-contain">
                            <span>Manage</span>
                        </a>
                    </li>
                    ...
                    {{-- Materials --}}
                    <li>
                        <a href="{{ route('superadmin.materials') }}"
                            class="flex items-center gap-3 px-3 rounded-lg text-sm transition-colors
                                {{ request()->is('superadmin/materials*')
                                    ? 'font-bold text-colab-blue bg-blue-50 border-l-4 border-colab-blue'
                                    : 'text-gray-500 hover:bg-colab-gray-light' }}">
                            <img src="{{ asset(request()->is('superadmin/materials*') ? 'images/materials-active.png' : 'images/materials.png') }}"
