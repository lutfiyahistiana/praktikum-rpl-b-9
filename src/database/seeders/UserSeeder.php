...
class UserSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ([1, 2, 3, 4, 5] as $roleId) {
            UserRole::create(['id_user' => $superadmin->id_user, 'id_role' => $roleId]);
        }
        ...
        foreach ([3, 4] as $roleId) {
            UserRole::create(['id_user' => $admin->id_user, 'id_role' => $roleId]);
        }
        ...
        foreach ([5, 3] as $roleId) {
            UserRole::create(['id_user' => $shafa->id_user, 'id_role' => $roleId]);
        }
        ...
        foreach ([1, 2, 3, 4, 5] as $roleId) {
            UserRole::create(['id_user' => $lutfiyah->id_user, 'id_role' => $roleId]);
        }
        ...
        foreach ($dummyUsers as $data) {
            ...
            UserRole::create(['id_user' => $user->id_user, 'id_role' => 5]);
        }
    }
}